...
public class IntakeSetPositionDelayGrp extends SequentialCommandGroup {

  /** Creates a new IntakeSetPositionDelayCmd. */
  public IntakeSetPositionDelayGrp(ArmSub armSub, MastSub mastSub, IntakeSub intakeSub) {
