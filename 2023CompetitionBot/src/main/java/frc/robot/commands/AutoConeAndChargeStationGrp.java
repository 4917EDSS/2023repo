...
public class AutoConeAndChargeStationGrp extends SequentialCommandGroup {
  /** Creates a new AutoConeAndChargeStation. */
  public AutoConeAndChargeStationGrp(ArmSub armSub, MastSub mastSub, IntakeSub intakeSub, DrivetrainSub drivetrainSub,
      LedSub ledSub) {
