...
public class AutoHomeAndDriveParallelGrp extends ParallelCommandGroup {
  /** Creates a new AutoHomeAndDriveParallelCmd. */
  public AutoHomeAndDriveParallelGrp(ArmSub armSub, MastSub mastSub, IntakeSub intakeSub, DrivetrainSub drivetrainSub) {
