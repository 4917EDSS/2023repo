...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_operatorController.povRight().whileTrue(new StartEndCommand(() -> m_manipulatorSub.moveMast(0.6),
        () -> m_manipulatorSub.moveMast(0.0), m_manipulatorSub));
    m_operatorController.povLeft().whileTrue(new StartEndCommand(() -> m_manipulatorSub.moveMast(-0.6),
        () -> m_manipulatorSub.moveMast(0.0), m_manipulatorSub));
    m_operatorController.triangle().whileTrue(
        new StartEndCommand(() -> m_gripperSub.setValve(true), () -> m_gripperSub.setValve(false), m_gripperSub));
